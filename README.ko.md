...
Claude Code 또는 기타 Agent Skills 호환 도구를 사용한다면 포함된 [Agent Skill](./skills/mikro-orm-markdown/SKILL.md)로 MikroORM 프로젝트에 `mikro-orm-markdown`을 설정하고 문제를 진단할 수 있습니다.
